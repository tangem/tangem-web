...
const BuyModal = ({ buyModal, handleBuyModal }) => {
  ...
  return (
    ...
    >
      ...
      >
        <div className="h-12 p-5px absolute top-0 right-1.5 z-50 lg:flex lg:justify-center cursor-pointer">
          <img src='./img/common/close.png' className='h-full' onClick={handleBuyModal} />
        </div>

        <div className="text-[#090E13] text-32px text-center font-semibold mt-32px lg:mt-10 mb-32px lg:mb-10">Pricing</div>

        <div className="flex flex-col md:grid md:grid-cols-2 md:gap-x-7 px-4 lg:px-0">

          <div className="h-[482px] lg:h-[572px] flex flex-col items-center bg-white rounded-20px p-8 mb-[1.875rem] lg:mb-0 shadow-[0_30px_100px_-15px_rgba(0,0,0,0.15)]">
            {/* <div className='max-h-60'>
              <img
                src='./img/buy/3_cards.png'
                alt='3 pack wallet tangem'
                className='h-[171px] md:h-full text-center mx-auto'
              />
            </div>
          ...
          <div className="h-[482px] lg:h-[572px] flex flex-col items-center bg-white rounded-20px p-8 mb-24 lg:mb-0 shadow-[0_30px_100px_-15px_rgba(0,0,0,0.15)]">
            {/* <div className='max-h-60'>
